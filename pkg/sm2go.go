...
func writeTest(otline []string, name string) []string{
	...
	otline = append(otline, "}()\n")
	otline = append(otline, "for {\n")
	otline = append(otline, "fmt.Scan(&input)\n")
	otline = append(otline, "if input == \"q\" {\n")
	otline = append(otline, "fmt.Println(\"quit\")\n")
	otline = append(otline, "break\n")
	otline = append(otline, "}\n")
	otline = append(otline, "}\n")
	otline = append(otline, "}\n")
	otline = append(otline, "\n")
