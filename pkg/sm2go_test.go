...
// 図の情報（xmlファイル）の解析情報を表示するテスト(stop_watch)
func TestSM2Go01(t *testing.T) {
	data := []byte(`
  <mxGraphModel dx="2746" dy="1249" grid="1" gridSize="10" guides="1" tooltips="1" connect="1" arrows="1" fold="1" page="0" pageScale="1" pageWidth="827" pageHeight="1169" math="0" shadow="0">
  <root>
    <mxCell id="0" />
    ...
    <mxCell id="EBAIrEwSQ_sO8G7dM4pI-16" style="edgeStyle=orthogonalEdgeStyle;rounded=0;orthogonalLoop=1;jettySize=auto;html=1;exitX=0;exitY=0.75;exitDx=0;exitDy=0;entryX=1;entryY=0.75;entryDx=0;entryDy=0;" parent="1" source="EBAIrEwSQ_sO8G7dM4pI-13" target="Mj1HlDtWmFxS42TAMx8B-1" edge="1">
      <mxGeometry relative="1" as="geometry">
    ...
    <mxCell id="EBAIrEwSQ_sO8G7dM4pI-15" style="edgeStyle=orthogonalEdgeStyle;rounded=0;orthogonalLoop=1;jettySize=auto;html=1;entryX=0;entryY=0.5;entryDx=0;entryDy=0;exitX=1;exitY=0.25;exitDx=0;exitDy=0;" parent="1" source="Mj1HlDtWmFxS42TAMx8B-1" target="EBAIrEwSQ_sO8G7dM4pI-13" edge="1">
      <mxGeometry relative="1" as="geometry">
